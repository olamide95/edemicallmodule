...
import { OutstandingBalanceReport } from "@/components/admin/reports/outstanding-balance-report"
import { CollectionReport } from "@/components/admin/reports/collection-report"
import { IncomeReport } from "@/components/admin/reports/income-report"
import { PaymentReport } from "@/components/admin/reports/payment-report"
            ...
            <div className="p-6 relative">
              <div className="max-w-[60%]">
                ...
                <div className="flex items-center gap-2 text-sm mb-4">
                  ...
                  <span className="text-primary italic">Reports</span>
                </div>

                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6 italic">
                  View, analyze and export comprehensive financial reports for better decision making and financial tracking.
                </p>
              </div>
