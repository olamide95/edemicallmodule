...
import { StatementGenerator } from "@/components/admin/statements/statement-generator"
            ...
            <div className="p-6 relative">
              <div className="max-w-[60%]">
                ...
                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6 italic">
                  Generate, view, and export detailed financial statements for students and guardians.
                </p>
              </div>

              <div className="absolute right-0 top-0 h-full flex items-center">
                <Image
                  src="/statements-illustration.png"
                  alt="Statements Illustration"
                  width={400}
                  height={200}
