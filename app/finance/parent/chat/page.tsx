...
"use client"
import { ParentChatInterface } from "@/components/parent/chat/parent-chat-interface"
          ...
          <div className="bg-light-card-bg dark:bg-dark-card-bg rounded-lg overflow-hidden shadow-sm mb-6">
            <div className="p-6 relative">
              <div className="max-w-[60%]">
                <h1 className="text-2xl font-bold mb-1">School Support</h1>
...
Chat with school administrators                </p>
