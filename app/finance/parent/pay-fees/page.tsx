...
import { PaymentForm } from "@/components/parent/payment-form"
        ...
        <main className="flex-1 overflow-y-auto bg-light-bg dark:bg-[#28243D] p-6">
          ...
          <div className="bg-light-card-bg dark:bg-dark-card-bg rounded-lg overflow-hidden shadow-sm mb-6">
            <div className="p-6 relative">
              <div className="max-w-[60%]">
                <h1 className="text-2xl font-bold mb-1">Pay Fees</h1>
                ...
                <div className="flex items-center gap-2 text-sm mb-4">
                  ...
                  <span className="text-primary italic">Fee Payment</span>
                </div>

                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6 italic">
                  Make payments for your children's school fees securely and conveniently
                </p>
          ...
          <Card className="border border-divider">
            <CardHeader>
              ...
              <CardDescription>Select children and payment method to proceed</CardDescription>
            </CardHeader>
            <CardContent>
              <PaymentForm />
            </CardContent>
