            ...
            <div className="p-6 relative">
              <div className="max-w-[60%]">
                ...
                <div className="flex items-center gap-2 text-sm mb-4">
                  ...
                  <span className="text-primary italic">Parent View</span>
                </div>

                <p className="text-light-text-secondary dark:text-dark-text-secondary mb-6 italic">
                  Welcome to your parent dashboard. Here you can view your child's progress and communicate with teachers.
                </p>
